...
PICS = (environ.get('PICS','https://files.catbox.moe/ccg6yt.jpg  https://files.catbox.moe/ccg6yt.jpg https://files.catbox.moe/ccg6yt.jpg')).split()
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Dqanshi:an12if@cluster0.2cvux.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Rajappan")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL',-1002423841190))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'danger_bots')
...
DELETE_TIME = int(environ.get('DELETE_TIME', 10))
