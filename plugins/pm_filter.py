...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
            ...
            msg1 = await query.message.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton("⚠️ 𝖢𝖺𝗇'𝗍 𝖠𝖼𝖼𝖾𝗌𝗌 ❓ 𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾 ⚠️", url=f'https://t.me/Db_autofilter_bot')
                        ]
                    ]
                )
            )
     ...
     [
        ...
        buttons = [[
        InlineKeyboardButton('ᴅᴋ ʙᴏᴛx', url='https://t.me/danger_bots'),
        InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/blazingsquad_support'),
        InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.delete()
